...
public class Robot : MonoBehaviour
{
    ...
    void Initialize()
    {
        ...
        switch (_team)
        {
            ...
            case Team.TeamA: { _stackable = new StackingTeamA(_mode); break; }
            case Team.TeamB: { _stackable = new StackingTeamB(_mode); break; }
            case Team.TeamC: { _stackable = new StackingTeamC(_mode); break; }
            case Team.TeamD: { _stackable = new StackingTeamD(_mode); break; }
            case Team.TeamE: { _stackable = new StackingTeamE(_mode); break; }
            default:
    ...
    void OnGUI()
    {
        ...
        _team = (Team)GUILayout.SelectionGrid((int)_team, new[] { "Debug", "Team A", "Team B", "Team C", "Team D", "Team E" }, 6);
