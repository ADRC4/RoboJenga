...
{
    public bool Connected => mDataListner.Connected;
    ...
    Vector3 ToUnity(Vector3 v) => new Vector3(v.z, v.y, v.x);


    // ORIGINAL MOTIVE CODE BEIGNS HERE

#pragma warning disable 0649
    string multicastIP = "239.255.42.99";
    // string hostIP = "10.97.85.186"; //"10.0.1.6";
    int dataPort = 1511;
    // public int commandPort = 1510;
    string NatNetVersion = "2.7.0.0";
    static double currentTimestamp = 0.0f;
    ...
    // float updateModelDefTime = 60.0f;
    // bool modelDefUpdated = false;
